...
class App extends React.Component {
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          dataOfTodo: [
            {
              id: 1,
              title: "do a to-do app",
              description: "for Caphyon",
              priority: "high",
              status: "Active"
            },
            {
            ...
            },
            {
              ...
              title: "Lorem Ipsum",
              description:
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent molestie massa in diam facilisis laoreet.",
              priority: "medium",
              status: "Active"
            },
            {
              id: 5,
              title: "Vestibulum tempus",
              description:
                "Morbi laoreet dolor leo, eget lacinia ipsum egestas ut. Phasellus quis lorem vitae nisi pharetra fermentum.",
              priority: "low",
              status: "Active"
            }
          ],
  ...
  componentDidMount() {
    document.getElementById("addTitle").value = this.state.toAdd.title;
    document.getElementById("addText").value = this.state.toAdd.description;
  ...
  changeToFolder(index) {
     ...
     */
    document.getElementById("addTitle").value = state.toAdd.title;
    document.getElementById("addText").value = state.toAdd.description;
